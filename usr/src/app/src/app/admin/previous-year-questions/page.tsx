...
const PaperField = ({ subjectIndex, paperIndex, control, removePaper }: { subjectIndex: number, paperIndex: number, control: any, removePaper: (index: number) => void }) => {
    return (
        <div className="space-y-2 p-2 border rounded-md relative">
        ...
        <div className="space-y-3 p-3 border rounded-lg bg-muted/50">
            ...
            <div className="space-y-2 pl-4">
             ...
             <div className="flex justify-end">
                <Button type="button" variant="outline" size="sm" onClick={() => appendPaper({ title: '', pdf: null })}>
...
const QuestionForm = ({
  ...
  const form = useForm<QuestionFormValues>({
    ...
    defaultValues: {
      ...
      subjects: question?.subjects || [{ name: "", papers: [{ title: "", pdf: null }] }],
    },
  });
        ...
        <div className="grid gap-4 py-4 pr-2">
            ...
            <div className="space-y-4 pt-4 border-t">
                ...
                <div className="flex justify-end mt-2">
                    <Button type="button" variant="outline" onClick={() => append({ name: "", papers: [{ title: "", pdf: null }] })}>
                  ...
                  {loading ? (
                    ...
                    questions.map((question) => (
                      <TableRow key={question.id}>
                        <TableCell className="font-medium">{question.exam}</TableCell>
        ...
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              This will permanently delete the question paper for <span className="font-semibold">{deletingQuestion?.exam} {deletingQuestion?.year}</span>. This action cannot be undone.
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>

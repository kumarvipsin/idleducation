...
export function Footer() {
  return (
    <footer className="bg-[#F5F5F7] text-gray-800 dark:bg-gray-900 dark:text-gray-300">
        <div className="container mx-auto py-12 px-4 md:px-6">
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 text-left">
                {/* Column 1: Our Branch */}
                <div>
                    <h3 className="text-lg font-extrabold mb-4 text-black dark:text-white pb-2 inline-block bg-gradient-to-r from-red-500 from-50% to-primary to-50% bg-no-repeat bg-bottom" style={{ backgroundSize: '100% 2px' }}>Our Branch</h3>
                    <div className="mt-4">
        ...
        <div className="bg-[#F5F5F7] dark:bg-gray-900 border-t border-gray-200 dark:border-gray-800">

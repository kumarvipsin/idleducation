...
export function HeroSection() {
  ...
  return (
    <Dialog open={isFormOpen} onOpenChange={setIsFormOpen}>
        <section className="relative w-full bg-cover bg-center bg-no-repeat pb-20" style={{backgroundImage: "url('https://picsum.photos/seed/student-bg/1920/1080')"}} data-ai-hint="student smiling">

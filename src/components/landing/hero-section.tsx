            ...
            <div className="grid lg:grid-cols-1 gap-8 items-center text-center">
                <div className="space-y-4 text-white">
                    ...
                    <DialogTrigger asChild>
                        <Button size="default" className="rounded-full transition-all duration-300 ease-in-out text-black bg-white hover:bg-gray-100 hover:shadow-lg hover:shadow-white/30">

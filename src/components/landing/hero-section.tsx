...
export function HeroSection() {
  ...
  return (
    <section className="relative w-full bg-cover bg-center bg-no-repeat" style={{backgroundImage: "url('https://picsum.photos/seed/hero3/1920/1080')"}} data-ai-hint="abstract geometric pattern">

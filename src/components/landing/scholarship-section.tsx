    ...
    return (
        <section className="w-full pt-4 sm:pt-6 pb-2 sm:pb-3 bg-[#FCFBF8] dark:bg-background">
            <div className="container mx-auto px-4 md:px-6">
                <div className="relative rounded-[22px] bg-white dark:bg-card p-4 sm:p-7 md:p-8 border border-slate-200/80 dark:border-border/60 shadow-sm md:shadow-md overflow-hidden">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-12 gap-4 sm:gap-6 md:gap-8 items-center">
                        ...
                        <div className="md:col-span-7 flex flex-col items-start text-left space-y-3.5 sm:space-y-5">
                            {/* Branded Pill Badge */}
                            ...
                            <div className="pt-1">
                                <Button 
                                    ...
                                    className="h-11 px-6 rounded-[10px] bg-[#FF6B16] hover:bg-[#e65a0c] text-white font-semibold text-sm shadow-xs hover:shadow-sm transition-all duration-200 border-none cursor-pointer"
                                >
                                    Register For FREE
                                </Button>
                        ...
                        <div className="md:col-span-5 w-full flex items-end justify-center self-end -mb-4 sm:-mb-7 md:-mb-8 pt-1 sm:pt-2">
                            <div className="relative w-full h-[230px] min-[390px]:h-[260px] sm:h-[320px] md:h-[340px] lg:h-[380px] flex items-end justify-center">
                                <Image
                                    src="/idlsch.png"

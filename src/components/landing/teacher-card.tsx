...
export function TeacherCard({ name, designation, experience, biography, avatar, avatarHint }: TeacherCardProps) {
     return (
        <Dialog>
            ...
            >
                <div className="absolute top-0 left-0 w-full h-24 bg-gradient-to-br from-gray-100 to-gray-200 dark:from-gray-800 dark:to-gray-900 rounded-t-lg"></div>
            ...
            <DialogContent className="sm:max-w-md bg-background/90 backdrop-blur-sm border-primary/20 border rounded-2xl shadow-2xl text-foreground">

...
const resources = [
  {
    ...
    title: "Notes",
    description: "Master your subjects with comprehensive, simplified notes designed to enhance conceptual clarity and accelerate exam revision.",
            ...
            >
                <CarouselContent className="-ml-4">
                    {resources.map((resource, index) => (
                        <CarouselItem key={index} className="pl-4 basis-[90%] sm:basis-[80%] md:basis-1/2 lg:basis-1/3">
                                    ...
                                    <Card className={cn(
                                        ...
                                        <CardContent className="p-4 sm:p-5 flex flex-col flex-1 text-left items-start">
                                            ...
                                            <div className="flex items-center justify-between w-full mb-3">
                                              ...
                                              <span className="text-[11px] font-semibold text-slate-400 dark:text-slate-500">Free Access</span>
                                            </div>
                                            ...
                                            <p className="text-xs sm:text-[13px] text-slate-600 dark:text-slate-400 font-medium leading-relaxed line-clamp-3 mb-4 flex-1">
                                            ...
                                            <div className="mt-auto pt-3 border-t border-slate-100 dark:border-slate-800/80 w-full flex items-center justify-between">
                                                ...
                                                <span className="text-[10px] font-semibold text-slate-400 dark:text-slate-500">Instant PDF</span>
                                            </div>
                                        </CardContent>
                                    </Card>
                                </Link>

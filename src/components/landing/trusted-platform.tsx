      ...
      <div className="container mx-auto px-4 md:px-6">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
          <div className="space-y-6 text-left">
            <h2 className="text-3xl md:text-4xl lg:text-5xl font-black tracking-tight text-primary mt-8">
          ...
          <div className="relative h-[400px] flex items-center justify-center">
            ...
            <div className="absolute left-[10%] bottom-[10%] animate-float">
                <div className="relative w-[105px] h-[105px]">
                 ...
                 <div className="absolute bottom-7 -right-32 w-36 bg-white p-2 rounded-lg shadow-lg">
                    <p className="text-[10px] leading-tight text-gray-800">IDL is where student learn with love and can grow with guidance</p>
            ...
            <div className="absolute right-[10%] top-[10%] animate-float" style={{ animationDelay: '0.5s' }}>
                <div className="relative w-[105px] h-[105px]">
                 ...
                 <div className="absolute top-8 -left-44 w-48 bg-green-100 p-3 rounded-lg shadow-lg">

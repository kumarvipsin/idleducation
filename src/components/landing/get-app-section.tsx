        ...
        <div className="rounded-[2.5rem] bg-white p-8 md:p-12 relative overflow-hidden shadow-sm">
          ...
          <div className="relative z-10 grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
            ...
            <div className="lg:col-span-4 flex flex-col items-center justify-center gap-6">
                <div className="flex items-center gap-6 p-6 bg-slate-50/40 dark:bg-slate-900/40 backdrop-blur-xl rounded-[2rem] border border-white/40 dark:border-white/10 shadow-2xl w-full sm:w-auto">

...
import { doc, setDoc, deleteDoc, updateDoc, getDoc, writeBatch, arrayUnion, arrayRemove, serverTimestamp, deleteField } from "firebase/firestore";
...
export async function addChapter(
    ...
    chapterName: string, 
    pdfFile: File | null, 
    longNotePdfFile: File | null, 
    shortNotePdfFile: File | null, 
    primumNotePdfFile: File | null
) {

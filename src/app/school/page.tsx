...
const coursesByCategory: { [key: string]: any[] } = {
  'Class 6': [
    ...
    },
    {
      ...
      image: "https://images.unsplash.com/photo-1594400385292-9a5a6d36e3e5?q=80&w=2070&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8",
      imageHint: "students writing",
      title: "Young Scholars Offline Batch",
      tags: ["LIMITED", "English"],
      target: "Targeted Batch for Class 6",
  ...
  'Class 9': [
    ...
    },
    {
      mode: "OFFLINE",
      modeColor: "bg-red-600",
      image: "https://images.unsplash.com/photo-1552664730-d307ca884978?q=80&w=2070&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8",
      imageHint: "team meeting",
      title: "Momentum Offline Class 9",
      tags: ["FAST-FILLING", "English"],
      target: "In-person learning for Class 9",
      startDate: "1 Aug, 2025",
      endDate: "25 Mar, 2026",
      price: "1,200",
      originalPrice: null,

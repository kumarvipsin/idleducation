...
export default function ContactPage() {
  ...
  return (
    <>
      <div className="bg-gradient-to-b from-blue-50 to-purple-50 dark:from-gray-900 dark:to-gray-800 py-12 md:py-24">
            ...
            <div className="grid md:grid-cols-2 gap-12 max-w-6xl mx-auto">
                <div className="space-y-8">
                    <div>
                        ...
                        <p className="text-muted-foreground">Find us at our head office or reach out via phone or email.</p>
                    </div>
                     <div className="space-y-6 flex-grow mt-8">
                        {contactDetails.map((item, index) => (
                          <div key={index} className="flex items-start gap-4 p-4 rounded-lg bg-background/50 border">

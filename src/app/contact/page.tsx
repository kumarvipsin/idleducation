...
export default function ContactPage() {
  ...
  const countryCodes = [
    ...
    { code: "+61-C", country: "Christmas Island" },
    { code: "+61-CC", country: "Cocos Islands" },
    ...
    { code: "+599-A", country: "Netherlands Antilles" },
    ...
    { code: "+47-S", country: "Svalbard and Jan Mayen" },
    ...
    { code: "+212-W", country: "Western Sahara" },

      ...
      <div className="container mx-auto py-12 px-4 md:px-6">
        <div className="max-w-6xl mx-auto">
          <Card className="shadow-lg overflow-hidden flex flex-col md:flex-row border-t-8 border-primary rounded-t-lg">
            <div className="p-8 md:w-1/2 bg-white dark:bg-card mt-[2.5%] mb-[2.5%] ml-[2.5%] mr-[1.25%] border rounded-lg flex flex-col justify-start">
            ...
            <div className="md:w-1/2 mt-[2.5%] mb-[2.5%] mr-[2.5%] ml-[1.25%] flex flex-col gap-4">

  ...
  const contents = (
    <div>
      ...
      <div className="space-y-4 md:space-y-6">
        {class12PhysicsResources.books.filter(b => b.lang === contentsLang).map((book, bookIndex) => (
          <div key={bookIndex}>
    ...
    <Card className="shadow-lg overflow-hidden border-t-8 border-sky-700">
      <div className="bg-gradient-to-r from-sky-500 to-cyan-600 text-white p-4">
        <div className="flex items-center gap-4">
          ...
          <div>
            <CardTitle className="text-2xl font-bold">Class 12 | Physics | CBSE</CardTitle>
          </div>
        </div>
      </div>

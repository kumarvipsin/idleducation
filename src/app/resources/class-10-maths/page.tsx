    ...
    <div className="container mx-auto py-12 px-4 md:px-6">
      <Card className="shadow-lg">
        <CardHeader className="bg-primary text-primary-foreground">
          <CardTitle className="text-2xl">Class 10 | Maths</CardTitle>
          <CardDescription className="text-primary-foreground/80">Explore resources for Class 10 Maths (2025 NCERT Syllabus).</CardDescription>
        </CardHeader>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            ...
            <div>
              ...
              <div className="space-y-4">
                {class10MathsResources.papers.map((paper, index) => (

    ...
    <div className="container mx-auto py-12 px-4 md:px-6">
      <Card className="shadow-lg">
        <CardHeader className="bg-primary text-primary-foreground">
          <CardTitle className="text-2xl">Class 6 | Social Studies</CardTitle>
          <CardDescription className="text-primary-foreground/80">Explore resources for Class 6 Social Studies (2025 NCERT Syllabus).</CardDescription>
        </CardHeader>

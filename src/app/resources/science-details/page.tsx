...
import { FileText, BookOpen, ChevronRight, Edit, BrainCircuit, Download } from "lucide-react";
    ...
    <Card className="shadow-lg overflow-hidden">
      <div className="bg-gradient-to-r from-blue-500 to-indigo-600 text-white p-4">
        <div className="flex items-center gap-4">
          ...
          <div>
            <CardTitle className="text-2xl font-bold">Class 10 | Science</CardTitle>
          </div>
        </div>
      </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-5 gap-6 md:gap-8 max-w-7xl mx-auto">
          ...
          <div className="lg:col-span-2">
            <div className="flex justify-between items-center mb-4">
                <h2 className="text-xl md:text-2xl font-bold text-foreground">Notes</h2>

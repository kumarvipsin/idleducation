...
import { BookText, ArrowRight, HelpCircle } from 'lucide-react';
  ...
  return (
    <div className="py-12 bg-white">
      <div className="text-center mb-12 animate-fade-in-up">
        <h1 className="text-3xl md:text-4xl font-extrabold text-primary tracking-tight mb-2">Notes for {selectedClass}</h1>
      ...
      <div className="px-4 md:px-6">
            {loading ? (
              ...
              <div key={animationKey} className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-6 justify-center animate-fade-in-up w-fit mx-auto">
                      ...
                      <Link key={`${subject.href}-${index}`} href={subject.href} className="block h-full group">
                        ...
                        >
                          ...
                          <CardContent className="p-4 flex-grow flex flex-col">
                            ...
                            <p className="text-xs text-muted-foreground mb-3">Notes for {subject.name}.</p>

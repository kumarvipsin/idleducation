...
export default function Class6SocialPage() {
  ...
  const contents = (
    <div>
        ...
        {class6SocialResources.books.filter(b => b.lang === contentsLang).map((book, bookIndex) => (
          <div key={bookIndex}>
    ...
    <Card className="shadow-lg overflow-hidden border-t-8 border-amber-700">
        <div className="bg-gradient-to-r from-amber-500 to-orange-600 text-white p-4">
          <div className="flex items-center gap-4">
            ...
            <div>
              <CardTitle className="text-2xl font-bold">Class 6 | Social Studies | CBSE</CardTitle>
            </div>
          </div>
        </div>

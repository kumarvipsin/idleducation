        ...
        <Card className="max-w-5xl mx-auto overflow-hidden shadow-xl p-8">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-x-12 gap-y-8">
                <div>
                    ...
                    <p className="text-foreground/80">We develop content by keeping by simplicity and flow of learning in mind. All the content on our platform is simple in language and easily relatable.</p>
                </div>
                 <div>
                    <h3 className="text-xl font-bold mb-2">Highly Skilled</h3>
                    <p className="text-foreground/80">Everyone working behind the scene is highly skilled and motivated to develop and deliver the quality content.</p>
                </div>
                 <div>
                    <h3 className="text-xl font-bold mb-2">Learning cycle</h3>
                    <p className="text-foreground/80">We develop our content according to the learning cycle of the students. We give most of our efforts and time to research and understand that how a student learns and understands.</p>
                </div>
                 <div>
                    <h3 className="text-xl font-bold mb-2">Your growth</h3>
                    <p className="text-foreground/80">The biggest success for a teacher is the growth of students. As an educational institute our priority is your growth. We always try to make our content worth more.</p>
                </div>
            </div>
        </Card>
      </section>

            ...
            <div className="container mx-auto px-4 md:px-6">
                 <div className="relative">
                    ...
                    <div className="relative z-10 space-y-6 text-lg text-foreground/80 leading-relaxed">
                        <p>IDL Education is a <span className="relative inline-block"><span className="relative z-10">reputed and result-driven</span><span className="absolute -bottom-1 left-0 w-full h-2 bg-yellow-300 z-0"></span></span> educational institute founded in 2016 by Amod Sharma with the vision of providing <span className="relative inline-block"><span className="relative z-10">quality education</span><span className="absolute -bottom-1 left-0 w-full h-2 bg-yellow-300 z-0"></span></span> through strong academic foundations and expert guidance. Over the years, IDL Education has grown into a <span className="relative inline-block"><span className="relative z-10">trusted name in education</span><span className="absolute -bottom-1 left-0 w-full h-2 bg-yellow-300 z-0"></span></span>, operating four successful offline branches across Delhi. The institute offers comprehensive coaching for Classes 6 to 12 (CBSE Board), covering Science, Commerce, and Humanities streams, and focuses on developing <span className="relative inline-block"><span className="relative z-10">conceptual clarity, confidence, and academic excellence</span><span className="absolute -bottom-1 left-0 w-full h-2 bg-yellow-300 z-0"></span></span> among students.</p>
                        <p>At IDL Education, learning goes beyond textbooks. The institute follows a <span className="relative inline-block"><span className="relative z-10">structured, student-centric teaching approach</span><span className="absolute -bottom-1 left-0 w-full h-2 bg-yellow-300 z-0"></span></span> that emphasizes concept-based learning, regular assessments, personalized mentoring, and continuous performance tracking. In addition to school academics, IDL Education provides dedicated preparation for CBSE Board Examinations (Class 10 & 12), CUET, NIOS, and other government and entrance examinations, ensuring that students are <span className="relative inline-block"><span className="relative z-10">well-prepared for both academic and competitive challenges</span><span className="absolute -bottom-1 left-0 w-full h-2 bg-yellow-300 z-0"></span></span>.</p>
                        <p>IDL Education is widely recognized for its <span className="relative inline-block"><span className="relative z-10">consistent outstanding results</span><span className="absolute -bottom-1 left-0 w-full h-2 bg-yellow-300 z-0"></span></span>. Students from all streams—Science, Commerce, and Humanities—have achieved excellent scores in CBSE Class 10 and 12 examinations, while many others have secured impressive success in CUET and government entrance exams, earning admissions to reputed colleges and universities. Backed by <span className="relative inline-block"><span className="relative z-10">experienced faculty, small batch sizes, updated study material, and a disciplined yet supportive learning environment</span><span className="absolute -bottom-1 left-0 w-full h-2 bg-yellow-300 z-0"></span></span>, IDL Education remains committed to <span className="relative inline-block"><span className="relative z-10">shaping confident learners and building successful futures</span><span className="absolute -bottom-1 left-0 w-full h-2 bg-yellow-300 z-0"></span></span>.</p>
                    </div>
                </div>
            </div>
        </section>

            ...
            <SidebarMenuAccordion defaultValue="user-management">
                ...
                <SidebarMenuSub value="course-content">
                    ...
                    <SidebarMenuSubItem>
                        ...
                        <SidebarMenuButton asChild isActive={pathname.startsWith('/admin/paid-courses')}>
                           <Link href="/admin/paid-courses">
                                <DollarSign />

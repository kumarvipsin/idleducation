...
import { addPaidCourse, editPaidCourse } from '@/app/actions/paid-courses';
...
export function PaidCourseForm({ course, onSuccess }: { course?: TPaidCourse | null; onSuccess: () => void }) {
  ...
  const onSubmit = async (data: CourseFormValues) => {
    ...
    const result = course ? await editPaidCourse(course.id, formData) : await addPaidCourse(formData);

...
import { getNotes, setClassData, updateSubject, updatePart, addChapter, addTopic, deleteClass, editClass } from '@/app/actions';
  ...
  const handleFormSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
        if (type === 'class') {
            ...
            if (action === 'add') {
                result = await setClassData('notes', newClassId, {});

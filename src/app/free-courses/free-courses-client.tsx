                    ...
                    <div className="relative overflow-hidden aspect-[4/3]">
                        ...
                        />
                         ...
                         <div className="absolute top-4 left-4">
                            <Badge className="bg-white/90 backdrop-blur-md text-primary font-black px-3 py-1 rounded-full shadow-lg border-none text-[10px] tracking-wider uppercase">FREE COURSE</Badge>
                         </div>
                    </div>
